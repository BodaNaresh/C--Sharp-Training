    ...
    public class Atmapp : IUserLogin, IUserAccountActions, ITransaction
    {
        ...
        public void InitializeData()
        {
            userAccountList = new List<UserAccount>
            {
                ...
                new UserAccount{Id=2, FullName = "Hari", AccountNumber=456789,CardNumber =121212, CardPin=333333,AccountBalance=4000.00m,IsLocked=false},
                new UserAccount{Id=3, FullName = "Pinky", AccountNumber=112233,CardNumber =131313, CardPin=444444,AccountBalance=2000.00m,IsLocked=false},
                new UserAccount{Id=4, FullName = "Ajay", AccountNumber=111222,CardNumber =141414, CardPin=555555,AccountBalance=3000.00m,IsLocked=true},
